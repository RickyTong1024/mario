...
public class UILabel : UIWidget
{
	...
	[HideInInspector][SerializeField] Effect mEffectStyle = Effect.Outline8;
	[HideInInspector][SerializeField] Color mEffectColor = new Color(32, 32, 32);
	[HideInInspector][SerializeField] NGUIText.SymbolStyle mSymbols = NGUIText.SymbolStyle.Normal;
	[HideInInspector][SerializeField] Vector2 mEffectDistance = new Vector2(1, 1);
	[HideInInspector][SerializeField] Color mEffectColor1 = new Color(32, 32, 32);
	[HideInInspector][SerializeField] Vector2 mEffectDistance1 = new Vector2(2, 2);
	...
	public Color effectColor1
	{
		get
		{
			return mEffectColor1;
		}
		set
		{
			if (mEffectColor1 != value)
			{
				mEffectColor1 = value;
				if (mEffectStyle != Effect.None) shouldBeProcessed = true;
			}
	...
	public Vector2 effectDistance1
	{
		get
		{
			return mEffectDistance1;
		}
		set
		{
			if (mEffectDistance1 != value)
			{
				mEffectDistance1 = value;
				shouldBeProcessed = true;
			}
		}
	}
	...
	protected override void OnStart ()
	{
		...
		mEffectColor = new Color(16 / 256.0f, 16 / 256.0f, 16 / 256.0f);
		mEffectDistance = new Vector2(1, 1);
		mEffectColor1 = new Color(48 / 256.0f, 48 / 256.0f, 48 / 256.0f);
		mEffectDistance1 = new Vector2(2, 2);
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		if (effectStyle != Effect.None)
		{
			...
			Vector2 pos1 = new Vector2(mEffectDistance1.x, mEffectDistance1.y);
			ApplyShadow1(verts, uvs, cols, offset, end, pos1.x, -pos1.y);
	...
	public void ApplyShadow1 (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols, int start, int end, float x, float y)
	{
		Color c = mEffectColor1;
		c.a *= finalAlpha;
		Color32 col = (bitmapFont != null && bitmapFont.premultipliedAlphaShader) ? NGUITools.ApplyPMA(c) : c;
