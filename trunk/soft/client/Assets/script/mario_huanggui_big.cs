...
public class mario_huanggui_big : mario_charater {
	...
	public override void set_bl(int index, int num)
	{
		...
		if (index == 0 && num == 4)
		{
			...
			l.Add(0);
			l.Add(0);
			mario_obj obj1 = play_mode._instance.create_mario_obj_ex("mario_huangguike_big", null, l, -1, -1, m_pos.x, m_pos.y + 900);
			obj1.m_velocity.set(0, 150);
		}
	}
