...
public class mario_goutou_big : mario_charater {
	...
	void go_die()
	{
		...
		l.Add(0);
		l.Add(0);
		mario_obj obj1 = play_mode._instance.create_mario_obj_ex("mario_goutou", null, l, -1, -1, m_pos.x, m_pos.y + 400);
		obj1.m_velocity.set(-40, 150);
		...
		l.Add(0);
		l.Add(0);
		mario_obj obj2 = play_mode._instance.create_mario_obj_ex("mario_goutou", null, l, -1, -1, m_pos.x, m_pos.y + 400);
		obj2.m_velocity.set(40, 150);
	}
